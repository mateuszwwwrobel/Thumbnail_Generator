...
class S3Resource:
    ...
    def get_random_file(self, bucket_name: str):
    ...
    def save_image_to_bucket(self, image: io.BytesIO, bucket_name: str,
                             new_file_name: str, file_extension: str = 'png') -> str:
...
def resized_image_url(resized_key: str) -> str:
